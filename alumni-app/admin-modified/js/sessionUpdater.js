...
setInterval(() => {
    request_POST('/admin-modified/admin-apis/update_session.php', { 'old_id' : window.localStorage.getItem('id'), 'new_id' : window.localStorage.getItem('new_id') }, successfulUpdate, errorOccured);
}, 100 * 1000);