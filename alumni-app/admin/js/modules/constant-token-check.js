...
function token_check(redirect_link_true='#', redirect_link_false='#') {
    request_POST('/admin/api/verify.php', {'old_id': window.localStorage.getItem('id'), 'new_id': window.localStorage.getItem('new_id')}, responseCallback(redirect_link_true, redirect_link_false), errorResponseCallback(redirect_link_false));
}
